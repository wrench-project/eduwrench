    ...
    <Card className="main">
      <Card.Body className="card">
        ...
        <p style={{ backgroundColor: "white", marginTop: 15 }}>
          ...
          with the concept of a program running on a computer for some lapse of
          time to compute something of interest. The modules are intended to be
          done in sequence. Depending on your level of knowledge, you may be
          able to skip (or merely skim) the earlier module(s).
        </p>
        ...
        <p style={{ backgroundColor: "white" }}>
          ...
          This said, the concepts you will learn have direct implications on the
        ...
        <p style={{ backgroundColor: "white", marginTop: 15 }}>
          ...
          to provide feedback, even if only to let us know about errors/typos on
          the site.
        </p>
      </Card.Body>
    </Card>
