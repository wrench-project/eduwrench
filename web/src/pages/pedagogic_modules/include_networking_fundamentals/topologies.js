    ...
    <>
      ...
      <PracticeQuestions
        ...
        questions={[
          {
            key: "A.3.1.p2.1",
            question: " What is the latency of the route from host E to host D? Show your work.",
            content: (
              <>
          ...
          {
            key: "A.3.1.p2.2",
            question: "What is the bandwidth of the route from host E to host D? Show your work.",
            content: (
              <>
          ...
          {
            key: "A.3.1.p2.3",
            question: "I am a user sitting at host E and have to download a large file. That file is on a Web site " +
              "at host A but also on a mirror Web site at host D.  Which mirror should I select? Explain your " +
              "reasoning.",
            content: (
              <>
          ...
          {
            key: "A.3.1.p2.4",
            question: "What is the transfer time for sending 1 MB of data from host E to host D? Show your work.",
            content: (
              <>
