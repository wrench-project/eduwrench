    ...
    return (
        <>
            ...
            <p>
                ...
                How low should the overhead <TeX math="h" /> be so that using Option #2 is at least as good as using Option #1?
            </p>
            ...
            <p>
                ...
                of the optimal number of tasks to run locally.
            ...
            <p>
                ...
                <ul>
                    <li><b>File Registry service:</b> 2 seconds for a "give me a file's location" request and 1 second for a "here is a new file location" request;</li>
