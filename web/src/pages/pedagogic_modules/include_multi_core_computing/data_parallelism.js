        ...
        <>
         ...
         = 10\text{sec}" block />
            ...
            <PracticeQuestions questions={[
                ...
                {
                    key: "A.2.p5.5",
                    question: "A program consists of a sequential phase and a perfectly parallelizable phase. When executed " +
                        "on 1 core, the parallel phase accounts for 92% of the execution time. What fraction of the execution " +
                        "time on 6 cores does this phase account for? Show your work and reasoning.",
                    content: (
                        <>
              ...
              = .65" block />
                ...
                {
                    key: "A.2.p5.6",
                    question: "40% of the sequential execution time of a program is spent in a phase that could be perfectly " +
