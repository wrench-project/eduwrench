    ...
    <>
      ...
      <Segment.Group>
        ...
        <Segment>
          <Formik
            ...
            onSubmit={(values, { setSubmitting }) => {
              setTimeout(() => {
                ...
                setSimulationResults(<></>)
                axios.post(`${window.location.protocol}//${window.location.hostname}/backend/run/multi_core_independent_tasks_ram`, data).then(
                  response => {
                    setSimulationResults(
                      <>
          ...
          <SimulationFeedback simulationID={'multi_core_computing/ram_simulation'} trigger={runtimes === 3}/>
        </Segment>
      </Segment.Group>
