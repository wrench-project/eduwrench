  ...
  return (
    <>
      ...
      <PracticeQuestions questions={[
        {
          key: "A.3.4.p4.1",
          question: "Estimate the execution time when all data-parallel tasks use 3 cores. Show your work, and " +
        ...
        {
          key: "A.3.4.p4.2",
          question: "Say that you must configure two of the data-parallel tasks to use  1 core, and the third one " +
        ...
        {
          key: "A.3.4.p4.3",
          question: "Say we configure each data-parallel to run on 2 cores. Which of these tasks  will run on the " +
            "same host? Come up with an answer using either reasoning (i.e., don't compute anything), and then " +
            "double-check it in simulation.",
          content: "When using 2 cores, the yellow task will still be the longest task, so it will be placed by " +
            "itself on a host. The blue and purple task will run on the same host. This is confirmed in the " +
            "simulation output."
        },
        {
          key: "A.3.4.p4.4",
          question: "Because the yellow task is so expensive, we decide to always run it on 3 cores. Is it better " +
            "to give 1 core to the blue task and 2 cores to the purple task, or the other way around? Show your " +
            "work/reasoning.",
          content: (
            <>
