...
const JobNumNodes = () => {
    return (
        <>
            ...
            <p>
                Because we know that <tt>myprogram</tt> runs in <TeX math="2 + 2/n"/> hours on <TeX math="n"/> nodes, we
            ...
            <p>
                ...
                <ul>
                    ...
                    <li> Submit a 2-node job, asking for just enough time for <tt>myprogram</tt> to complete successfully.</li>
                    <li> What is this job's turnaround time?</li>
                    <li> Reset the simulation and submit a 4-node job, asking for just enough time for
                        <tt>myprogram</tt> to complete successfully.</li>
