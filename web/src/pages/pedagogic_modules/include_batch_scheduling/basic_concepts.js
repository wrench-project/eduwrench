    ...
    return (
        <>
            <Segment.Group className="objectives">
                ...
                <Segment style={{ backgroundColor: "#fafafa" }}>
                    <ul style={{ backgroundColor: "#fafafa" }}>
                        <li>Understand the basic need for and concept of batch scheduling</li>
            ...
            *shared* among users. This sharing can be done in different ways depending
            ...
            way to allow this sharing is with a <strong>batch scheduler</strong>.
            </p>
            ...
            cluster's nodes.  Each job specifies a desired <i>number of nodes</i>, a desired
            <i>duration</i>, and a program to run on these nodes. For instance, a job can
            say: "I need 4 nodes for 2 hours".  These job requests are placed in a
            <strong>queue</strong>, where they wait until the nodes they need are available. A
            ...
            <p>
            <strong>Disclaimer</strong>: This module does not provides comprehensive Slurm training, but instead
