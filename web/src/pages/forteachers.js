...
const ForTeachers = () => (
  <Layout>
    ...
    <Segment>
      ...
      <ul>
        <li><a style={{ color: "#c78651" }} href="#targetaudience"> What is the target audience?</a></li>
        <li><a style={{ color: "#c78651" }} href="#objectives"> What are the learning objectives?</a></li>
        <li><a style={{ color: "#c78651" }} href="#curriculummap"> What is the curriculum map?</a></li>
        <li><a style={{ color: "#c78651" }} href="#curriculum"> What is the relationship to the NSF/IEEE-TCPP
          Curriculum?</a></li>
        <li><a style={{ color: "#c78651" }} href="#integration"> How can these modules be integrated into courses?</a>
        </li>
        <li><a style={{ color: "#c78651" }} href="#server"> How to run your own EduWRENCH server?</a></li>
        <li><a style={{ color: "#c78651" }} href="#help"> How to get help or get involved?</a></li>
      </ul>
    </Segment>
