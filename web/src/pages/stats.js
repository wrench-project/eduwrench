...
const Stats = () => {
    ...
    const resetAllPracticeQuestions = ()  => {
        ...
        axios
            .post(window.location.protocol + "//" + window.location.hostname + "/backend" + "/get/resetpracticequestions", {
                userName: userName,
                email: userEmail,
            })
            .then((response) => {
    ...
    useEffect(() => {
        ...
        const userName = localStorage.getItem("userName")
        axios
            .post(window.location.protocol + "//" + window.location.hostname + "/backend" + "/get/userdata", {
                userName: userName,
                email: userEmail,
            })
            .then((response) => {
